...
export interface ApiSpielerlevelSpielerlevel
  extends Struct.CollectionTypeSchema {
  collectionName: 'spielerlevels';
  info: {
    displayName: 'Spielerlevel';
    pluralName: 'spielerlevels';
    singularName: 'spielerlevel';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiTrainingTraining extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    spielerlevels: Schema.Attribute.Relation<
      'oneToMany',
      'api::spielerlevel.spielerlevel'
    >;
    updatedAt: Schema.Attribute.DateTime;
